...
import { Button, Box, Tooltip } from '@mui/material';
import { FaLinkedin, FaGithub, FaMedium, FaFileAlt, FaGraduationCap } from 'react-icons/fa';
import { useContext } from 'react';
import { ThemeContext } from '../theme/ThemeContext';
  ...
  return (
    ...
    >
      ...
      <Tooltip title="Google Scholar">
        <Button
          color="inherit"
          href="https://scholar.google.co.in/citations?user=1ebWnUQAAAAJ&hl=en&authuser=1"
          target="_blank"
          rel="noopener noreferrer"
          sx={iconStyle}
        >

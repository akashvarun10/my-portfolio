...
//           <Grid key={index} item xs={4} sm={4} md={4} lg={3} xl={3} style={{ maxWidth: '350px', margin: '20px' }}>
...
//                   color: '#76885B', // optional, sets the text color to white
//                   borderRadius: '1rem', // optional, adds a rounded edge to the button
//                 }}
//               >
//                 View More
...
//         boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)',
//         position: 'relative',
//         backgroundColor: toggleState === index + 1 ? 'white' : 'transparent', // Conditional background color
//       }}>
//         <IconButton onClick={() => toggleTab(0)} style={{ position: 'absolute', top: '1.5rem', right: '1.5rem' }}>
//           <HiX style={{ fontSize: '1.5rem', color: 'var(--title-color)' }} />
//         </IconButton>

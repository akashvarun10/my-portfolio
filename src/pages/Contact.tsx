...
// //     emailjs
// //       .sendForm('service_05khnsx', 'template_ayrrp4p', form.current!, 'dzabdbeW9GeOgv3Wk')
// //       .then(
// //         (result) => {
...
// //     emailjs
// //       .sendForm('service_05khnsx', 'template_5zig02v', form.current!, 'dzabdbeW9GeOgv3Wk')
// //       .then(
// //         (result) => {
// //           console.log(result.text);
// //         },

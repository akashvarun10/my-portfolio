...
//       <section>
//         <Typography variant="h3" align="center" gutterBottom color="#76885B" sx={{ fontSize: '24px', fontWeight: 700, textTransform: 'uppercase', marginBottom: '2rem' }}>
...
const Experience: React.FC = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <section>
      <Typography variant="h2" align="center" sx={{ mb: 2, color: '#76885B', fontWeight: 400, fontFamily: '"Roboto","Helvetica","Arial",sans-serif', fontSize: '32px' }}>
          Education & Experience
        </Typography>
        <ExperienceContainer id="resume">
          <div style={{ flex: '1 1 100%' }}>
            <Typography variant="h4" align="center" sx={{ fontSize: '20px', fontWeight: 600, textTransform: 'uppercase', marginBottom: '1.5rem', color: '#76885B' }}>
              <HiAcademicCap style={{ marginRight: '8px' }} />
              Education
            </Typography>
            {educations.map(education => (
              <div key={education.title}>
          ...
          <div style={{ flex: '1 1 100%' }}>
            <Typography variant="h4" align="center" sx={{ fontSize: '20px', fontWeight: 600, textTransform: 'uppercase', marginBottom: '1.5rem', color: '#76885B' }}>
              <HiOutlineBriefcase style={{ marginRight: '8px' }} />
              Experience
            </Typography>
            {experiences.map(experience => (
              <div key={experience.title}>
